...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      id="home" 
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white section-padding pt-24"
    >
      <div 
        className={`container max-w-4xl mx-auto text-center transition-all duration-1000 ${
