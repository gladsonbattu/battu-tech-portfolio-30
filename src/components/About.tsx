      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-[2fr_1fr] gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg leading-relaxed scroll-animate stagger-1">
          ...
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm scroll-animate stagger-3">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start scroll-animate stagger-1">
                <span className="text-primary mr-2">•</span>
                <span>AI/ML implementation specialist</span>
              </li>
              <li className="flex items-start scroll-animate stagger-2">
                <span className="text-primary mr-2">•</span>
        ...
        {/* Experience Section */}
        <div className="mt-20">
          <h3 className="font-semibold text-2xl mb-8 scroll-animate">Experience</h3>
          
          <div className="space-y-8">
            <div className="bg-gray-50 p-6 rounded-lg hover:shadow-md transition-all duration-300 hover-scale scroll-animate stagger-1">
            ...
            <div className="bg-gray-50 p-6 rounded-lg hover:shadow-md transition-all duration-300 hover-scale scroll-animate stagger-2">
            ...
            <div className="bg-gray-50 p-6 rounded-lg hover:shadow-md transition-all duration-300 hover-scale scroll-animate stagger-3">
        ...
        {/* Education Section */}
        <div className="mt-20">
          <h3 className="font-semibold text-2xl mb-8 scroll-animate">Education</h3>
